...
- **Organization structure** (department/district hierarchy, Station/Unit reference tables) is new scope this planning session surfaced — `FUTURE.md` Epic 2.
...
- **Admin department-settings page** — now has real scope: `FUTURE.md` Epic 2 (Organization/Station/Unit settings) and Epic 5 (NERIS credentials), built as one settings area rather than speculative fields with no screen.
