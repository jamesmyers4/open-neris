...
export default async function NewRescueNonFfPage(props: PageProps<'/incidents/[id]/rescues/new-nonff'>) {
  ...
  return (
    <main className="mx-auto max-w-2xl p-8">
      <h1 className="mb-6 text-2xl font-bold">Add non-firefighter casualty</h1>
